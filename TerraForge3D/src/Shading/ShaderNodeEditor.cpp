...
void SNEPin::SetType(SNEPinType type)
{
	...
	switch(type)
	{
		case SNEPinType_Float: color = ImColor(FLOAT_PIN_COLOR); break;
		case SNEPinType_Float2: color = ImColor(FLOAT2_PIN_COLOR); break;
		case SNEPinType_Float3: color = ImColor(FLOAT3_PIN_COLOR); break;
		case SNEPinType_Bool: color = ImColor(BOOL_PIN_COLOR); break;
	}
}
