...
void NoiseOpenSimplex2Node::Load(nlohmann::json data)
{
...
nlohmann::json NoiseOpenSimplex2Node::Save()
{
	nlohmann::json data;
	data["type"] = MeshNodeEditor::MeshNodeType::NoiseOpenSimplex2;
...
NoiseOpenSimplex2Node::NoiseOpenSimplex2Node()
{
	...
	seed = 42; frequency = 1.01f; yVal = 0.0f; fractalType = 0;
	octaves = 3; lacunarity = 2.0f; gain = 0.5f; weightedStrength = 0.0f; // should be within 0 to 1
