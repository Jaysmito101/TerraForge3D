...
void NoiseOpenSimplex2SNode::Load(nlohmann::json data)
{
...
nlohmann::json NoiseOpenSimplex2SNode::Save()
{
	nlohmann::json data;
	data["type"] = MeshNodeEditor::MeshNodeType::NoiseOpenSimplex2S;
...
NoiseOpenSimplex2SNode::NoiseOpenSimplex2SNode()
{
	...
	yVal = 0.0f; lacunarity = 2.0f; gain = 0.5f; weightedStrength = 0.0f; // should be within 0 to 1
