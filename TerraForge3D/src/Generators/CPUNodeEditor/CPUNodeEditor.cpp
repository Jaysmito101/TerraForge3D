...
:appState(as)
{
	...
	config.insNodeFunc = [&](nlohmann::json data) -> NodeEditorNode* {
		...
		switch (type)
		{
			case CPUNodeEditorE::CPUNodeType::Dummy:                node = new DummyNode(); break;
			case CPUNodeEditorE::CPUNodeType::Output:               node = new OutputNode(); break;
			case CPUNodeEditorE::CPUNodeType::MeshCoordinates:      node = new MeshCoordinatesNode(); break;
			case CPUNodeEditorE::CPUNodeType::MaxMeshCoordinates:   node = new MaxMeshCoordinatesNode(); break;
			case CPUNodeEditorE::CPUNodeType::MinMeshCoordinates:   node = new MinMeshCoordinatesNode(); break;
			case CPUNodeEditorE::CPUNodeType::TextureCoordinates:   node = new TextureCoordinatesNode(); break;
			case CPUNodeEditorE::CPUNodeType::TimeBasedSeed:        node = new TimeBasedSeedNode(); break;
			case CPUNodeEditorE::CPUNodeType::Duplicate:            node = new DuplicateNode(); break;
			case CPUNodeEditorE::CPUNodeType::Add:                  node = new AddNode(); break;
			case CPUNodeEditorE::CPUNodeType::Sub:                  node = new SubNode(); break;
			case CPUNodeEditorE::CPUNodeType::Mul:                  node = new MulNode(); break;
			...
			case CPUNodeEditorE::CPUNodeType::Curve:                node = new CurveNode(); break;
			case CPUNodeEditorE::CPUNodeType::RandomNumber:         node = new RandomNumberNode(); break;
			case CPUNodeEditorE::CPUNodeType::NoisePerlin:          node = new NoisePerlinNode(); break;
			case CPUNodeEditorE::CPUNodeType::NoiseCellular:        node = new NoiseCellularNode(); break;
			case CPUNodeEditorE::CPUNodeType::NoiseOpenSimplex2:    node = new NoiseOpenSimplex2Node(); break;
			case CPUNodeEditorE::CPUNodeType::NoiseOpenSimplex2S:   node = new NoiseOpenSimplex2SNode(); break;
			case CPUNodeEditorE::CPUNodeType::NoiseValue:           node = new NoiseValueNode(); break;
			case CPUNodeEditorE::CPUNodeType::NoiseValueCubic:      node = new NoiseValueCubicNode(); break;
			case CPUNodeEditorE::CPUNodeType::MathFunction:         node = new MathFunctionNode(); break;
			case CPUNodeEditorE::CPUNodeType::Texture:              node = new TextureNode(); break;
