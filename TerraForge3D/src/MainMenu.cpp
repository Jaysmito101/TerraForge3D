...
void MainMenu::ShowFileMenu()
{
	...
	{
	case ApplicationMode::TERRAIN:				modelToExport = appState->models.coreTerrain; break;
	case ApplicationMode::CUSTOM_BASE:			modelToExport = appState->models.customBase; break;
	default:									modelToExport = appState->models.coreTerrain; break;
	}
