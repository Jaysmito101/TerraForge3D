...
namespace tf3d::base
{
    ...
    public:
        ...
        inline const std::vector<Vert> &GetVertices() const
        {
            return m_Vertices;
        }
        ...
        inline const int *GetIndicesPTR() const
        {
            return reinterpret_cast<const int *>(m_Faces.data());
        }
        inline const Vert *GetVerticesPTR() const
        {
        ...
        inline const glm::vec4 &GetPosition(int index) const
        {
            return m_Vertices[index].position;
        }
        inline const glm::vec4 &GetNormal(int index) const
        {
            return m_Vertices[index].normal;
        }
        inline const glm::vec4 &GetTexCoord(int index) const
        {
        ...
        inline const Vert &GetVertex(int index) const
        {
            return m_Vertices[index];
        }
        inline void SetVertex(const Vert &v, int index)
        {
            m_Vertices[index] = v;
        }
        inline void SetPosition(const glm::vec4 &v, int index)
        {
            m_Vertices[index].position = v;
        }
        inline void SetNormal(const glm::vec4 &v, int index)
        {
...
using tf3d::base::Face;
using tf3d::base::Mesh;
using tf3d::base::MeshType;
using tf3d::base::Vert;
